...
//ES5 DRAW SOME ROADS ON THE SETTLEMENTS MODEL

var ROAD = function(r_x,r_y){
	var roads = COLOR([0,0,0])(CUBOID([0.05,0.15,0.01]));
	for (var i = 0; i < r_x; i=i+0.4) {
		for (var j = 0; j < r_y; j=j+0.4) {	};
	var road = T([1])([i+0.15])(COLOR([0,0,0])(CUBOID([1,0.05,0.01])));
	var roads = STRUCT([roads,road]);
};
return roads;
};
...
var r2 = ROAD(1,1);
var stl1 = T([0,1,2])([8,19.5,0.05])(STRUCT([basement,T([0,1])([1,1])(STRUCT([s1,r1]))]));
var stl2 = T([0,1,2])([5.4,3.2,0.1])(STRUCT([basement,T([0,1])([1,1])(STRUCT([s2,r2]))]));
