...
def ROAD (r_x,r_y):
	roads = COLOR([0,0,0])(CUBOID([0.05,0.15,0.01]))
	for i in range(0,r_x):
		road = T([2])([i+0.1])(COLOR([0,0,0])(CUBOID([1,0.05,0.01])))
		roads = STRUCT([roads,road])
	return roads
...
s2 = SETTLEMENTS(1,1)
r2 = ROAD(1,1)
stl1 = T([1,2])([8,19.5])(STRUCT([basement,T([1,2])([1,1])(STRUCT([s1,r1]))]))
stl2 = T([1,2])([5.2,3])(STRUCT([basement,T([1,2])([1,1])(STRUCT([s2,r2]))]))
